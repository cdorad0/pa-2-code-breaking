...
``` r
# Vectors containing the upper case letters, lower case letters, and some 
# punctuation marks using the object assignment '<-' 
...
``` r
# Vector containing all the symbols: lower_case, upper_case, punctuation
...
``` r
# Turning vector into a data frame, having one column named "symbol".
...
``` r
# Total number of symbols in the data frame.
...
``` r
# New variable in dataframe assigns a number to each symbol
